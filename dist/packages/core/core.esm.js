import { Injectable, NgZone, Component, ElementRef, EventEmitter, Input, Output, Directive, ContentChildren, QueryList, forwardRef, Self, Inject, InjectionToken, Optional, NgModule } from '@angular/core';
import { Observable, BehaviorSubject, from, timer, ReplaySubject, Subject } from 'rxjs';
import { flatMap, map, sample, switchMap, shareReplay, distinctUntilChanged, takeUntil } from 'rxjs/operators';
...
var GoogleMapsAPIWrapper = /** @class */ (function () {
     ...
     */
    function (latLng) {
        return this._map.then(function (map$$1) { return map$$1.setCenter(latLng); });
    };
    /**
     * @return {?}
     */
     ...
     * @return {?}
     */
    function () { return this._map.then(function (map$$1) { return map$$1.getZoom(); }); };
    /**
     * @return {?}
     */
     ...
     */
    function () {
        return this._map.then(function (map$$1) { return map$$1.getBounds(); });
    };
    /**
     * @return {?}
     */
     ...
     */
    function () {
        return this._map.then(function (map$$1) { return map$$1.getMapTypeId(); });
    };
    /**
     * @param {?} zoom
     * @return {?}
     ...
     */
    function (zoom) {
        return this._map.then(function (map$$1) { return map$$1.setZoom(zoom); });
    };
    /**
     * @return {?}
     */
     ...
     */
    function () {
        return this._map.then(function (map$$1) { return map$$1.getCenter(); });
    };
    /**
     * @param {?} latLng
     * @return {?}
     ...
     */
    function (latLng) {
        return this._map.then(function (map$$1) { return map$$1.panTo(latLng); });
    };
    /**
     * @param {?} x
     * @param {?} y
     ...
     */
    function (x, y) {
        return this._map.then(function (map$$1) { return map$$1.panBy(x, y); });
    };
    /**
     * @param {?} latLng
     * @return {?}
     ...
     */
    function (latLng) {
        return this._map.then(function (map$$1) { return map$$1.fitBounds(latLng); });
    };
    /**
     * @param {?} latLng
     * @return {?}
     ...
     */
    function (latLng) {
        return this._map.then(function (map$$1) { return map$$1.panToBounds(latLng); });
    };
    /**
        ...
        return this._infoWindows.get(infoWindow).then(function (w) {
            if (infoWindow.hostMarker != null) {
                return _this._markerManager.getNativeMarker(infoWindow.hostMarker).then(function (marker) {
                    return _this._mapsWrapper.getNativeMap().then(function (map$$1) { return w.open(map$$1, marker); });
                });
            }
            return _this._mapsWrapper.getNativeMap().then(function (map$$1) { return w.open(map$$1); });
        });
    };
    /**
     * @param {?} infoWindow
...
var AgmMap = /** @class */ (function () {
    ...
    function (el) {
        ...
        this._mapsWrapper.createMap(el, {
            ...
            .then(function (map$$1) { return _this.mapReady.emit(map$$1); });
     ...
     */
    function (bounds) {
        return bounds != null && (/** @type {?} */ (bounds)).extend === undefined;
    };
    /**
     * @return {?}
     */
    ...
    function () {
        ...
        var s = this._mapsWrapper.subscribeToMapEvent('center_changed').subscribe(function () {
            _this._mapsWrapper.getCenter().then(function (center) {
                ...
                _this.centerChange.emit(/** @type {?} */ ({ lat: _this.latitude, lng: _this.longitude }));
            });
        });
    ...
    function () {
        ...
        events.forEach(function (e) {
            ...
            var s = _this._mapsWrapper.subscribeToMapEvent(e.name).subscribe(function (event) {
                /** @type {?} */
                var value = /** @type {?} */ ({ coords: { lat: event.latLng.lat(), lng: event.latLng.lng() } });
...
var AgmDataLayer = /** @class */ (function () {
    ...
    function (changes) {
        ...
        /** @type {?} */
        var dataOptions = {};
        AgmDataLayer._dataOptionsAttributes.forEach(function (k) { return (/** @type {?} */ (dataOptions))[k] = changes.hasOwnProperty(k) ? changes[k].currentValue : (/** @type {?} */ (_this))[k]; });
...
var AgmMarker = /** @class */ (function () {
    ...
    function () {
        ...
        var ds = this._markerManager.createEventObservable('dragend', this)
            ...
            _this.dragEnd.emit(/** @type {?} */ ({ coords: { lat: e.latLng.lat(), lng: e.latLng.lng() } }));
        });
        this._observableSubscriptions.push(ds);
        /** @type {?} */
        var mover = this._markerManager.createEventObservable('mouseover', this)
            .subscribe(function (e) {
            _this.mouseOver.emit(/** @type {?} */ ({ coords: { lat: e.latLng.lat(), lng: e.latLng.lng() } }));
        });
        this._observableSubscriptions.push(mover);
        /** @type {?} */
        var mout = this._markerManager.createEventObservable('mouseout', this)
            .subscribe(function (e) {
            _this.mouseOut.emit(/** @type {?} */ ({ coords: { lat: e.latLng.lat(), lng: e.latLng.lng() } }));
        });
...
export { AgmCoreModule, AgmMap, AgmCircle, AgmRectangle, AgmInfoWindow, AgmKmlLayer, AgmDataLayer, AgmMarker, AgmPolygon, AgmPolyline, AgmPolylinePoint, AgmFitBounds, GoogleMapsAPIWrapper, CircleManager, RectangleManager, InfoWindowManager, MarkerManager, PolygonManager, PolylineManager, KmlLayerManager, DataLayerManager, GoogleMapsScriptProtocol, LAZY_MAPS_API_CONFIG, LazyMapsAPILoader, MapsAPILoader, NoOpMapsAPILoader, FitBoundsAccessor, coreDirectives as ɵb, FitBoundsService as ɵa, BROWSER_GLOBALS_PROVIDERS as ɵe, DocumentRef as ɵd, WindowRef as ɵc };
